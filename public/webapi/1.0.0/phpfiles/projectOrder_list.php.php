...
<p><img src="<?php echo SYS_EXTJS_URL?>images/apple2.gif" width="16" height="16" /> <span class="titlestyle">功能描述：项目订单列表接口</span></p>
...
<table width="90%" border="1" class="dbTable">
  ...
  <tr>
    <td>请求的地址</td>
    <td>[sys_web_service]projectOrder_list</td>
  </tr>
</table>

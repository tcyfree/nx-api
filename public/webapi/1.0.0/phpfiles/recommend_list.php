...
<p><img src="<?php echo SYS_EXTJS_URL?>images/apple2.gif" width="16" height="16" /> <span class="titlestyle">功能描述：推荐行动社列表接口</span></p>
...
<table width="90%" border="1" class="dbTable">
  ...
  <tr>
    <td>请求的地址</td>
      <td>GET</td>
    <td>v1/community/recommend/:page/:size</td>
  </tr>
</table>

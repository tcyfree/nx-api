...
<table width="90%" border="1" class="dbTable">
  ...
  <tr>
    <td>请求的地址</td>
    <td>[sys_web_service]checked_saveoperate</td>
  </tr>
</table>
...
<p><span class="inforstyle">特别说明：id从 <a href="#" onclick="javascript:sysOpenTab('menu_get_notice_list','获取列表','phpfiles/notice_list.php')">通知列表</a> 接口获得，此处由客户端传递是为了减少服务器查询次数，提高运行效率。</span></p>

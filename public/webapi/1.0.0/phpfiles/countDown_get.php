...
<p><img src="<?php echo SYS_EXTJS_URL?>images/apple2.gif" width="16" height="16" /> <span class="titlestyle">功能描述：获取活动倒计时接口</span></p>
...
<table width="90%" border="1" class="dbTable">
  ...
  <tr>
    <td>请求的地址</td>
    <td><p>[sys_web_service]countDown_get</p></td>
  </tr>
</table>

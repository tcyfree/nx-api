...
<form id="form1">
    ...
    ?>
      ...
      <span class="subtitlestyle">1、项目根地址：</span><span class="inforstyle">[sys_web_service] =<?php echo SYS_ROOT."/public/"?> </span>(该常量请务必配置在客户端，作为其他服务接口的前缀)
...
<p class="subtitlestyle">2、所有服务接口，返回数据采用JSON格式，其中都必包含3个关键字段：<span class="inforstyle">success 、msg 和 processTime</span></p>
